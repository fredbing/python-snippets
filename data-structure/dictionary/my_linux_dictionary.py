...
dict = {'alias': 'let you give your own name to a command or sequence of commands',
        ...
        'grep': 'search for lines containing a search pattern',
        'groups': 'tell which groups a user is in',
        'gzip': 'compress files',
        'head': 'give the top lines',
        ...
        'ps': 'list running processes with their process ID or PID',
        ...
        'top': 'show a real-time display of data relating to your Linux machine',
        'tree': 'print the directory structure',
        'uname': 'obtain system info of the Linux computer',
        'w': 'list the currently logged in users',
